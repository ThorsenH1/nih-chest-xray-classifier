...
|---|---|
| **Test Mean AUC** | **0.795** |
| Best performing | Hernia (0.928), Emphysema (0.895), Cardiomegaly (0.875) |
| Most challenging | Infiltration (0.699), Pneumonia (0.703), Nodule (0.715) |
| Training images | 112,120 |
| Architecture | ResNet50 (ImageNet pretrained) |
| Epochs | 3 |

> Reference: Wang et al. (CVPR 2017) reported a mean AUC of 0.745 with DenseNet-121. Our ResNet50 achieves **0.795** — exceeding this baseline by +5 AUC points with a single model and 3 epochs of fine-tuning.
...
Expected results after 3 epochs on a T4 GPU: mean test AUC ≈ 0.795 (this run).
